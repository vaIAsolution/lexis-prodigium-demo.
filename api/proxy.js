...
export default async (req, res) => {
  ...
  const { query, context } = req.body;
    ...
    if (query.startsWith("Busca y analiza la siguiente tesis o jurisprudencia:")) {
      ...
      prompt = `Actúa como un estratega legal experto y un asistente de investigación legal de élite en México. Tu tarea es realizar un análisis FODA (Fortalezas, Oportunidades, Debilidades, Amenazas) para el siguiente caso. Tu análisis debe ser **profundo, aplicado y accionable**.
